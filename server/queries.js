...
const postQuestion = (request, response) => {
    ...
    pool.query('INSERT INTO questions (q_text, a_correct, a_b, a_c, a_d, added_by_user, added_date) VALUES ($1, $2, $3, $4, $5, $6', [q_text, a_correct, a_b, a_c, a_d, added_by_user, 'date 2020-09-29'], (error, results) => {
      if (error) {
        throw error
      }
